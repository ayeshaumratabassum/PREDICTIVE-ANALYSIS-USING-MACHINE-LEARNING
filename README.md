...
• Python: Python was used as the primary programming language due to its simplicity, readability, and extensive support for machine learning libraries.

• Pandas: Pandas was used for data loading, cleaning, manipulation, and preprocessing.

• Scikit-learn: Scikit-learn was used to implement machine learning algorithms, perform data splitting, train the model, and evaluate its performance.
...
Feature selection was performed by choosing important attributes including Passenger Class (Pclass), Sex, Age, Fare, and Embarked. These features were used as input variables, while the Survived column was used as the target variable.
...
• Gender was one of the most influential factors affecting survival probability, with female passengers generally having higher survival rates.

• Passenger class significantly impacted survival chances, as higher-class passengers were more likely to survive.

• Age and fare also contributed to the prediction results, indicating their importance in passenger outcomes.

• The Logistic Regression model achieved good prediction accuracy on the test dataset.
